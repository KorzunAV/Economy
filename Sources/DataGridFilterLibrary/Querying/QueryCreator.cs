...
namespace DataGridFilterLibrary.Querying
{
    public class QueryCreator
    {
        ...
        public void CreateFilter(ref Query query)
        {
            ...
            foreach (var kvp in filtersForColumns)
            {
                ...
                if (partialFilter.Length > 0)
                {
                    ...
                    var paths = kvp.Value.ValuePropertyBindingPath.Split(new Char[] { '.' });
        ...
        {
            var creator = new StringFilterExpressionCreator(paramCounter, filterData, Parameters);
