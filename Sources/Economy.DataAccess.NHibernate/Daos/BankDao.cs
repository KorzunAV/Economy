...
namespace Economy.DataAccess.NHibernate.Daos
{
    ...
    {
        public BankDao(ISessionManager sessionManager) : base(sessionManager) { }

        public BankDto Save(BankDto dto)
        {
            return Save<BankDto, BankEntity>(dto);
        }

        public BankDto Get(int id)
        {
            BankEntity alias = null;
            ...
            var dto = SessionManager
                ...
                .And(restrictions)
                .TransformUsing(Transformers.AliasToBean<BankDto>())
                .SingleOrDefault<BankDto>();
            return dto;
        }
