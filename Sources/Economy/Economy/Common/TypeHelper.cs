...
namespace Economy.Common
{
    ...
    public class TypeHelper<T>
    {
        ...
        /// </summary>
        public static string PropertyName(Expression<Func<T>> expression)
        {
        ...
        /// 	Gets name of property.
        /// </summary>
        public static string PropertyName<TP>(Expression<Func<TP>> pe, Expression<Func<T>> expression)
        {
        ...
        /// 	Gets name of property.
        /// </summary>
        public static string PropertyName<TP1, TP2>(Expression<Func<TP1>> ppe, Expression<Func<TP2>> pe, Expression<Func<T>> expression)
        {
            return string.Join(PROPERY_ACCESSOR,
                        new[]
                            {
